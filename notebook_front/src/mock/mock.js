...
import notesData from './mockData/notesData';
import categories from "./mockData/categoriesData";
const Random = Mock.Random;

Mock.mock(RegExp('/api/categories/' + '.*'+'/notes'), 'get', options => {
  let currentCid=options.url.split("/")[3];
